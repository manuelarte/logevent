...
//
// The package provides core context helpers ([AddLogEventToContext], [UpdateLogEvent],
// [LogItFunc], [HandleWithLogEvent]) as well as ready-to-use middleware for
// HTTP (in subpackage mw/http) and gRPC (in subpackage mw/grpc).
package logevent
