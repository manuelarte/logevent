...
- We implement the [`Log`](./model.go#L9) method of the [`LogEvent`](./model.go) interface. This allows us to change the way we want to log the event based on the values.
